...
const Page = () => {
  ...
  const texts = [
    ...
    {
      text: "Хэрвээ айлын хүн чинь 10 метрийн цаана зогсож байна гэж бодоход тэр чиний 123px-г эзэлж байгаа бөгөөд хэрвээ чи 1920х1080 resolution дээр тоглож байгаа гэж бодоход чамд алдаж болох 2,073,477px байгаа буюу та оновчтой буудах шаардлагатай",
      bg: "bg-green-400",
    },
    {
